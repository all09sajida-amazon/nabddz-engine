// src/core/NabdzApp.js - The Body (Legacy Adapter)

/**
 * @object NabdzApp - The Body (Legacy Adapter)
 * @description الجسد المبسط الذي يتفاعل مع واجهة المستخدم.
 *              يعمل كـ "مكيف" (Adapter) بين القالب القديم والعقل الجديد (TheGenesisMind).
...
window.NabdzApp = {
    ...
    chatbot: {
        init() {
            ...
            if (bubble) bubble.addEventListener('click', () => window_el.classList.toggle('open'));
